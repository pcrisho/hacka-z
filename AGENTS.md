...
1. **`docs/00-bases/BASES-CONCURSO.md`** — reglas oficiales del concurso (fechas, criterios de evaluación, entregables obligatorios, descalificaciones). Ante cualquier conflicto con otra nota del repo, esto manda.
