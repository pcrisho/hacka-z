...
```mermaid
mindmap
  root((Soluciones Gen Z Pacífico))
    Microseguros On-Demand
      Seguro por evento o concierto
      Seguro de viaje modular
      Cobertura por trayecto en scooter o bici
    Salud Mental & Bienestar Holistico
      Teleterapia con psicologos seleccionados
      Copago cero en consultas digitales
      Gamificacion con habitos saludables
    Proteccion Digital & Gig Economy
      Seguro para laptop y smartphone laboral
      Proteccion contra ciberfraudes y suplantacion
      Respaldo financiero para freelancers
    Pet Care Digital
      Consultas veterinarias preventivas
      Cobertura de cirugias y accidentes
      Red de clinicas aliadas via app
    Seguros Embebidos Embedded
      Integracion nativa con Yape y e-commerce
      Adquisicion en 2 toques sin formularios
      Micro-ahorro y cashback por no siniestralidad
```
