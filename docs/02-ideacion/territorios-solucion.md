...
| Depende de historial crediticio/actuarial individual | Sí (pricing por IA) | Parcial | **No** — el "precio" es el hábito, no el score |
...
Un producto de **bienestar financiero + salud/salud mental** para el cruce Guardián + Estudiante/Primer Empleo (`PLAN-TRABAJO.md` §6): micro-hábitos semanales (ahorro chico, actividad física, chequeo preventivo, sesión de bienestar) trackeados vía app y —en una versión más ambiciosa— vía patrones de transacciones Yape, que desbloquean o hacen crecer una cobertura base de salud/bienestar sin costo, con top-ups opcionales pay-as-you-go y cancelables en un clic para coberturas puntuales (laptop, viaje). Recompensas no monetarias (contenido, sesiones, reconocimiento social), nunca descuentos.
